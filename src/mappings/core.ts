...
export function handleSync(event: Sync): void {
  ...
  zEx.totalLiquidityBNB = zEx.totalLiquidityBNB.plus(trackedLiquidityBNB)
  zEx.totalLiquidityUSD = zEx.totalLiquidityBNB.times(bundle.bnbPrice)
...
export function handleMint(event: Mint): void {
  ...
  zEx.txCount = zEx.txCount.plus(ONE_BI)
