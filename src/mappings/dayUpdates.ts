...
export function updateBSCswapDayData(event: EthereumEvent): void {
  ...
  if (bscswapDayData == null) {
    ...
    bscswapDayData.mostLiquidTokens = zEx.mostLiquidTokens
    bscswapDayData.txCount = ZERO_BI
    bscswapDayData.save()
  }
  bscswapDayData = BSCswapDayData.load(dayID.toString())
  bscswapDayData.totalLiquidityUSD = zEx.totalLiquidityUSD
  bscswapDayData.totalLiquidityBNB = zEx.totalLiquidityBNB
  bscswapDayData.txCount = zEx.txCount
  bscswapDayData.save()
}
